...
const items = [
  {
    title: "Keep track of your health using health calculators",
    content:
      "Fit4Sure helps track your workouts, get better results, and be the best version of you. Less thinking!",
    icon:
  ...
  {
    title: "Find the most suitable plan for you",
    content:
      "Fit4Sure helps track your workouts, get better results, and be the best version of you. Less thinking!",
    icon:
